...
function Game() {
    this.word = createRandomWord.randomWord();
    this.numIncorrect = 0;
    this.guessedLetters = "";
    this.guessesLeft = 6;
    if (!this.word) {
    ...
    return {
        ...
        chances:this.numIncorrect,
        wrongLetters:this.guessedLetters,
        incorrectGuesses:this.numIncorrect,
        getGuess: (guess) => {
            if (!isCorrect) {
                chances[this.guessesLeft]--;
                wrongLetters[this.guessedLetters] += guess;
                incorrectGuesses[this.numIncorrect] += 1;
